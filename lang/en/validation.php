...
return [
    ...
    */
    ...
    'after' => ':attribute tulee olla päivämäärän jälkeen päivän :date.',
    'after_or_equal' => ':attribute tulee olla tämä päivä tai sen jälkeen: :date.',
    ...
    'before_or_equal' => ':attribute tulee olla tämä päivä tai ennen sitä: :date.',
    'between' => [
        'numeric' => ':attribute tulee olla välillä :min - :max.',
        'file' => ':attribute tulee olla välillä :min - :max kilobittiä.',
        'string' => ':attribute tulee olla välillä :min - :max merkkiä.',
        'array' => ':attribute tulee olla välillä :min and :max tavaraa.',
    ],
    'boolean' => ':attribute tulee olla joko true (oikea) tai false (väärä).',
    'confirmed' => 'The :attribute confirmation does not match.',
    'date' => ':attribute ei ole hyväksyttävä päivämäärämuoto.',
    ...
    'distinct' => ':attribute on sama sisältöinen.',
    'email' => ':attribute tulee olla oikea sähköpostiosoite.',
    'ends_with' => ':attribute tulee loppua yhteen seuraavista: :values.',
    'exists' => 'Valittu :attribute on väärin kirjoitettu.',
